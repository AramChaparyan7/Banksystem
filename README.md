This is bank managing system. It contains number of bank accounts, and each bank account contains account holder, account number and balance. It allows you to create accounts, add it to bank.
Also it can
